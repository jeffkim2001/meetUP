//
//  LibertarianChatViewController.swift
//  meetUP
//
...
class LibertarianChatViewController: UIViewController {
    ...
    @IBAction func sendPressed(_ sender: AnyObject) {
        ...
        let messagesDB = Database.database().reference().child("Messages3")
    ...
    func retrieveMessages() {
        let messageDB = Database.database().reference().child("Messages3")
...
extension LibertarianChatViewController: UITableViewDelegate {
    
}

extension LibertarianChatViewController: UITableViewDataSource {
...
extension LibertarianChatViewController: UITextFieldDelegate {
